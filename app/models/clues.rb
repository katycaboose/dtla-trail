class Clues
  ...
  def initialize(string)
    ...
    @correct_answers = {
      ...
      'tiny house' => "you are so close to the end of the game\nat this place we know the owner by name\nnsmall, rank, and shady you’d\nthink it not ideal\nbut I l think it has fancy date appeal",
